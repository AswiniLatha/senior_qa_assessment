...
module.exports = { 
    //It will click Login button on Landing page
    ...
    //Log in to TRELLO with Username and Password
    enterUsernamePassword : function(browser) {
        ...
        .pause(10000)
        .waitForElementVisible(loginPage.elements.passwordInput, 10000)
    ...
    //Creates Card In First List of the board
